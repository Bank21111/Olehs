<script>
  ...
  (function() {
    ...
    **/
    ...
    ShootingStar.prototype.addBeamPart = function(x, y) {
      ...
      $("#star" + name).append("<div id='haz" + this.n + "' class='haz' style='position:absolute; color:#febdc6; width:10px; height:10px; font-weight:bold; font-size:" + this.options.starSize + "px'>·</div>");
      if (this.n > 1) $("#haz" + (this.n - 1)).css({
        color: "rgba(254, 189, 198,0.5)"
      });
      $("#haz" + this.n).css({
        top: y + this.n,
  ...
  $(document).ready(function() {
    var shootingStarObj = new ShootingStar("#stars");
